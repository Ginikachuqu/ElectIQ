...
const Admin: React.FC = () => {
  ...
  // State for election configuration
  ...
  const [activeSection, setActiveSection] = useState<'candidates' | 'configuration'>('candidates');
    ...
    <div className="container mx-auto mt-[4rem] p-6">
      ...
      >
        ...
        {activeSection === 'candidates' && (
          ...
          animate="visible"
          variants={containerVariants}
          className="max-w-xl mx-auto space-y-8 mt-8"
        >
            ...
            <form onSubmit={handleConfigSubmit} className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 border border-green-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              </div>
              ...
              <motion.button 
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-green-600 text-white py-3 rounded-xl hover:bg-green-700 transition duration-300 shadow-lg flex items-center justify-center"
              >
